...
var CONSTRUCTOR_METADATA = Symbol('Constructors');
...
var ConstructorMetadata = /** @class */ (function () {
    ...
    ConstructorMetadata.getMetadata = function (target) {
        var constructorMetadata = Reflect.getOwnMetadata(CONSTRUCTOR_METADATA, target);
...
function parse(json, type) {
    ...
    var constructorMetadata = ConstructorMetadata.getMetadata(type);
...
function Serializable() {
    return function (target) {
        ...
        var constructorMetadata = ConstructorMetadata.getMetadata(target);
